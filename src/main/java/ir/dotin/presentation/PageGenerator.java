...
public class PageGenerator {
    ...
    public static String generateAddOfLegalCustomerHTML(LegalCustomer legalCustomer){
        ...
        stringBuilder.append("                <br>");
        stringBuilder.append("                    <table class=result-table>");
        stringBuilder.append("<th style = \"background: #b8860b ; color: black; font-weight: bold; text-align: center \" > شماره مشتری </th>");
        stringBuilder.append("<th style = \"background: #b8860b ; color: black; font-weight: bold; text-align: center \" > نام شرکت </th>");
        stringBuilder.append("<th style = \"background: #b8860b ; color: black; font-weight: bold; text-align: center \" > تاریخ ثبت </th>");
        stringBuilder.append("<th style = \"background: #b8860b ; color: black; font-weight: bold; text-align: center \" > کد اقتصادی</th>");
